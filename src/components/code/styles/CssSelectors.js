  ...
  render() {
    return (
      <div className="u-margin-bottom-huge">
        <h2 className="u-alchemy-primary-colour">CSS Selectors</h2>
        <p>
        ...
        <p>
          <em>Selector Intent</em> is essentially all about deciding and defining what you are styling and how
          you will go about selecting it.
        </p>
        ...
        <p>
          You can have many <code className="u-alchemy-positive-colour">header</code> elements on a page, and
          they in turn can have many <code className="u-alchemy-positive-colour">ULs</code>, which can result
          in applying a very specific style to a wide range of elements.
        </p>
        ...
        <p>
          ...
          standard of writing selectors. So your selectors should be as explicit as your reason for wanting to
          select something.
        </p>
        <h3>Reusability</h3>
        <p>
          As we move towards a more component based codebase, everything you write should be able to be reused
        ...
        <p>
          ...
          class name of <code className="u-alchemy-positive-colour">.btn</code>, but this does not allow us to
          really reuse the <code className="u-alchemy-positive-colour">.btn</code> class on anything other
          than an <code className="u-alchemy-positive-colour">input</code>.
        </p>
        ...
        <table className="o-table  o-table--small  o-table--bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Components, for more specific UI that has a single source of truth, can be reused in location
        ...
        <ul className="u-margin-bottom-large">
          ...
          <li>
            then it will check if that <code className="u-alchemy-positive-colour">.header</code> class exists
            on a <code className="u-alchemy-positive-colour">div</code> element;
          </li>
          <li>
          ...
          <li>
            finally it will check if that <code className="u-alchemy-positive-colour">.home</code> class is on
            the <code className="u-alchemy-positive-colour">body</code> element;
          </li>
        </ul>
