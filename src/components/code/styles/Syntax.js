  ...
  render() {
    return (
      <div className="u-margin-bottom-huge">
        <h2 className="u-alchemy-primary-colour">Syntax and Code Formatting</h2>
        <p>
          By having set the standard for writing CSS, the code will always look and feel familiar to all
          developers.
        </p>
        <p>
          A clean codebase is generally a nicer environment to work in, especially as external factors can add
          undue stress into your workflow. Frontend developers have a duty to maintain best practices wherever
          possible.
        </p>
        ...
        <p>
          Since the rise in popularity of pre-processors such as Less and Sass, it has become more common form
          to split up code into discrete chunks fit for purpose.
        </p>
        <p>
          However, this has to be done in a sensible and logical way. Separating components out into their own
          semantically named files has the following benefits:
        </p>
        <ul className="u-margin-bottom-large">
        ...
        <p>
          It is useful for the main index.scss (or .less) file to contain a table of contents. This is useful
          because it tell a team of developers what files are contained within the codebase, where they are
          contained and via a concise comment, what that file actually represents.
        </p>
