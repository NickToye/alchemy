    ...
    return (
      <ScrollableAnchor id={'syntax'}>
        <div className="u-margin-bottom">
          ...
          <p>
            A clean codebase is generally a nicer environment to work in, especially as external factors
            can add undue stress into your workflow. Frontend developers have a duty to maintain best
          ...
          <p>
            Since the rise in popularity of pre-processors such as Less and Sass, it has become more
            common form to split up code into discrete chunks fit for purpose.
          </p>
          <p>
            However, this has to be done in a sensible and logical way. Separating components out into
            their own semantically named files has the following benefits:
          </p>
          <ul className="u-margin-bottom">
            <li>You know exactly where your files are</li>
            <li>You know what line of CSS you need to debug if there any issues</li>
            <li>
              Page specific files and foundation files are all in their own semantically named folders
            </li>
          </ul>
          ...
          <p>
            ...
            useful because it tell a team of developers what files are contained within the codebase,
            where they are contained and via a concise comment, what that file actually represents.
          </p>
          <p>Of course this can be a heavy overhead to maintain, but the benefits are worth it.</p>

          <h3>80 Characters Wide</h3>
          <p>
            Whenever possible limit the line widths to 80 characters long. This can be set project wide in
            the
          ...
          <p>
            Files with multiple sections within them should have 5 carriage spaces in between sections.
          </p>
