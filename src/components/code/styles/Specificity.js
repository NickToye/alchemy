  ...
  render() {
    return (
      <div className="u-margin-bottom-huge">
        <h2 className="u-alchemy-primary-colour">Specificity</h2>
        <p>
          Specificity is possibly the main reason why developers have to refactor their code. Even if you had
          good intentions, there could be a situation down the line where specifity becomes an issue.
        </p>
        <p>
        ...
        <p>
          ...
          <code className="u-alchemy-positive-colour">#main</code> element, but if down the line you are asked
          to chuck in another form and its style is different, then you may run into trouble.
        </p>
        <small className="a-code-label u-alchemy-negative-colour">
...
`}</code>
        ...
        <p>
          ...
          CSS for all forms, and apply that to elements, with the more specific selector intents for pieces of
          UI fit for purpose.
        </p>
        <h3>!important Flag</h3>
        <p>
          While is is generally assumed <code className="u-alchemy-positive-colour">!important</code> is seen
          as inheritently bad code, it does have a place in a codebase - albeit used sparingly and for very
          good reason.
        </p>
...
`}</code>
        ...
        <p>
          This is the wrong way to use <code className="u-alchemy-positive-colour">!important</code> flag, it
          is using it <strong>reactively</strong>, rather than <strong>proactively</strong>.
        </p>
      </div>
    );
  }
