...
/* PrismJS 1.14.0
http://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+jsx&plugins=line-numbers+toolbar+show-language */
var _self =
...
!(function(t) {
  ...
  var e = function(t) {
      return t
        ? 'string' == typeof t ? t : 'string' == typeof t.content ? t.content : t.content.map(e).join('')
        : '';
    },
    a = function(n) {
    ...
    Prism.plugins.toolbar.registerButton('show-language', function(t) {
      ...
      if (a && /pre/i.test(a.nodeName)) {
        var s =
          ...
          e[t.language] ||
          (t.language && t.language.substring(0, 1).toUpperCase() + t.language.substring(1));
        if (s) {
